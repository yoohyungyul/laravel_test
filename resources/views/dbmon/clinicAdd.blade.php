								...
								<div class="col-xl-2">
									<div class="form-group  " >
                                        ...
                                        <select class="form-control" name="region">
											...
											<option value="{{$Data->code}}">{{$Data->gov_name}}</option>
											@endforeach											
										</select>
                                    </div>
								</div>
						...
						<div class="form-group " >
							<div class="row">
												...
												<tr>
													<td>
														<select class="form-control" name="special_hospital_id[]">
															<option>선택</option>
															@foreach($specialHospitalData as $SpecialHospitalData) 
																<option value="{{$SpecialHospitalData->id}}" >{{$SpecialHospitalData->gov_name}}</option>
															@endforeach
														</select>													
													</td>												
								...
								<div class="col-xl-4">
									...
									@foreach($ClinicTypeData as $Data)
								...
								<div class="col-xl-4">									
									...
									<div class="input-group">
										...
										<input type="text" name="established" class="form-control" data-plugin="datepicker" value="{{ date('m/d/Y') }}">
									 </div>
												...
												<tr>
													<td>
														<select class="form-control" name="medical_subject_id[]">
															<option>선택</option>
															@foreach($medicalSubjectData as $MedicalSubjectData) 
																<option value="{{$MedicalSubjectData->id}}" >{{$MedicalSubjectData->gov_name}}</option>
															@endforeach
														</select>													
													</td>
												...
												<tr>
													<td>
														<select class="form-control" name="h_language_slug[]">
															<option>선택</option>
															@foreach($LangTypeData as $langtypedata) 
																<option value="{{$langtypedata->group_value}}">{{$langtypedata->group_str}}</option>
															@endforeach
														</select>
													</td>
...
$('#SpecialHospitalAdd').click(function () {
	var str = '<tr>'
			+ '<td><select class="form-control" name="special_hospital_id[]"> <option>선택</option> @foreach($specialHospitalData as $SpecialHospitalData) <option value="{{$SpecialHospitalData->id}}" >{{$SpecialHospitalData->gov_name}}</option> @endforeach	 </select></td>'
			+ '<td><button type="button" class="btn btn-sm btn-icon btn-flat btn-default removebutton"  ><i class="icon wb-close" aria-hidden="true"></i></button></td>'
			+ '</tr>';
...
$('#clinicHomepageAdd').click(function () {
	var str = '<tr>'
		+ '<td><select class="form-control" name="h_language_slug[]"><option>선택</option> @foreach($LangTypeData as $langtypedata) <option value="{{$langtypedata->group_value}}">{{$langtypedata->group_str}}</option> @endforeach </select></td>'
		+ '<td><input type="text" class="form-control" name="h_value[]"placeholder="URL을 입력해주세요" value=""/></td>'
		+ '<td><button type="button" class="btn btn-sm btn-icon btn-flat btn-default removebutton"  ><i class="icon wb-close" aria-hidden="true"></i></button></td>'
		+ '</tr>';
...
$('#clinicManagerAdd').click(function () {
	...
	var str = '<tr>'
		+ '<td><select class="form-control" value="m_language_slug[]"><option>선택</option> @foreach($LangTypeData as $langtypedata) <option value="{{$langtypedata->group_value}}" >{{$langtypedata->group_str}}</option> @endforeach </select></td>'
		+ '<td><input type="text" class="form-control" name="m_name[]" placeholder="이름을 입력해주세요" value=""/></td>'
		+ '<td><input type="text" class="form-control" name="m_tel[]" placeholder="전화번호를 입력해주세요" value=""/></td>'
		+ '<td><input type="text" class="form-control" name="m_phone[]" placeholder="휴대폰번호를 입력해주세요" value=""/></td>'
		+ '<td><input type="text" class="form-control" name="m_email[]" placeholder="이메일을 입력해주세요" value=""/></td>'
...
$('#clinicMedicalAdd').click(function () {
	...
	var str = '<tr>'
		+ '<td><select class="form-control" name="medical_subject_id[]"><option>선택</option> 	@foreach($medicalSubjectData as $MedicalSubjectData) <option value="{{$MedicalSubjectData->id}}" >{{$MedicalSubjectData->gov_name}}</option> @endforeach </select></td>'
		+ '<td><input type="text" class="form-control" name="special_doctor_count[]" placeholder="전문의수를 입력해주세요" value=""/></td>'
		+ '<td><input type="text" class="form-control" name="standard_doctor_count[]" placeholder="일반의수를 입력해주세요" value=""/></td>'
		+ '<td><button type="button" class="btn btn-sm btn-icon btn-flat btn-default removebutton"  ><i class="icon wb-close" aria-hidden="true"></i></button></td>'
		+ '</tr>';
