...
<!-- modal 창 모음 Start-->
	<?php echo $__env->make('dbmon_layouts.modal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>  
	<!-- modal 창 End -->
	...
	<!-- Top -->  
	<?php echo $__env->make('dbmon_layouts.top', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	<!-- End Top -->

	<!-- Side Menu -->  
	<?php echo $__env->make('dbmon_layouts.side_menu', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	<!-- End Side Menu -->
