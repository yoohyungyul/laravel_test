							...
							<div class="row">
								...
								<div class="col-xl-6">									
									...
									<div class="input-group">
										...
										<input type="text" name="established" class="form-control" data-plugin="datepicker" value="<?php echo e(date('Ymd')); ?>">
									 </div>
									 <p class="text-help">- YYYYMMDD</p>									
								</div>
							</div>
						</div>
								...
								<div class="col-xl-3">
									...
									<div class="form-group  " >
										<div class="input-group input-large" >
											<input type="text" class="form-control " name="start[]" maxlength="4" value="" >
											<span class="input-group-addon">~</span>											
											<input type="text" class="form-control " name="end[]" maxlength="4" value="">													  
										</div>
