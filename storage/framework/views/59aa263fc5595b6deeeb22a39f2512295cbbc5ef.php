...
function fuDoctorAdd() {
  ...
  url = "/modal/doctor/add?id=<?php echo e($id); ?>&returnurl=<?php echo e(urlencode($_SERVER['REQUEST_URI'])); ?>";
...
function fuDoctorMod(doctor_id) {
    ...
    url = "/modal/doctor/mod?doctor_id="+doctor_id+"&returnurl=<?php echo e(urlencode($_SERVER['REQUEST_URI'])); ?>";
